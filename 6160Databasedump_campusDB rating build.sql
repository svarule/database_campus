...
CREATE TABLE `driver_rating` (
  ...
  `Driver_Question_1` int DEFAULT NULL,
  `Driver_Question_2` int DEFAULT NULL,
...
INSERT INTO `driver_rating` VALUES (1,1,2),(2,2,3),(3,3,2),(4,2,1),(5,5,1),(6,3,1),(7,1,4),(8,3,5),(9,3,3),(10,5,5),(11,1,3),(12,3,4),(13,4,2),(14,2,1),(15,1,1),(16,3,5),(17,5,3),(18,4,4),(19,3,5),(20,3,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `order_AFTER_INSERT` AFTER INSERT ON `orders` FOR EACH ROW BEGIN
...
CREATE TABLE `rating` (
  ...
  PRIMARY KEY (`Rating_ID`),
  KEY `fk_orderid_rating_idx` (`Order_ID`),
  KEY `fk_driver_rating_idx` (`Driver_rating`),
  KEY `fk_restuarant_rating_idx` (`Restaurant_rating`),
  CONSTRAINT `fk_driver_rating` FOREIGN KEY (`Driver_rating`) REFERENCES `driver_rating` (`Rating_ID`),
  CONSTRAINT `fk_orderid_rating` FOREIGN KEY (`Order_ID`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `fk_restuarant_rating` FOREIGN KEY (`Restaurant_rating`) REFERENCES `restaurant_rating` (`Rating_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rating` VALUES (1,1,10,5,1),(2,2,11,4,2),(3,3,12,3,3),(4,4,13,2,4),(5,5,14,1,5),(6,1,15,5,1),(7,2,16,4,2),(8,3,17,4,3),(9,4,18,2,4),(10,5,19,1,5),(11,1,20,5,1),(12,2,21,4,2),(13,3,22,3,3),(14,4,23,2,4),(15,5,24,1,5),(16,1,25,5,1),(17,2,26,4,2),(18,3,27,3,3),(19,4,28,2,4),(20,5,29,1,5);
/*!40000 ALTER TABLE `rating` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `rating_data`
--

DROP TABLE IF EXISTS `rating_data`;
/*!50001 DROP VIEW IF EXISTS `rating_data`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rating_data` AS SELECT 
 1 AS `Overall_Rating`,
 1 AS `Order_id`,
...
CREATE TABLE `restaurant_rating` (
  `Rating_ID` int NOT NULL,
  `Rest_Question_1` int DEFAULT NULL,
  `Rest_Question_2` int DEFAULT NULL,
  PRIMARY KEY (`Rating_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `restaurant_rating` VALUES (1,1,2),(2,1,3),(3,1,4),(4,1,5),(5,2,1),(6,2,2),(7,2,3),(8,2,4),(9,2,5),(10,3,1),(11,3,2),(12,3,3),(13,3,4),(14,3,5),(15,4,1),(16,4,2),(17,4,3),(18,4,4),(19,4,5),(20,5,1);
...
--
-- Temporary view structure for view `vw_driver_rating`
--

DROP TABLE IF EXISTS `vw_driver_rating`;
/*!50001 DROP VIEW IF EXISTS `vw_driver_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_driver_rating` AS SELECT 
 1 AS `Overall_Rating`,
 1 AS `Order_id`,
 1 AS `Driver_rating`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `vw_order_rating`
--

DROP TABLE IF EXISTS `vw_order_rating`;
/*!50001 DROP VIEW IF EXISTS `vw_order_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_order_rating` AS SELECT 
 1 AS `order_id`,
 1 AS `total_price`,
...
--
-- Temporary view structure for view `vw_restaurant_rating`
--

DROP TABLE IF EXISTS `vw_restaurant_rating`;
/*!50001 DROP VIEW IF EXISTS `vw_restaurant_rating`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_restaurant_rating` AS SELECT 
 1 AS `Overall_Rating`,
 1 AS `Order_id`,
 1 AS `Restaurant_rating`,
 1 AS `Driver_rating`*/;
...
--
-- Final view structure for view `rating_data`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rating_data` AS select `t1`.`Overall_Rating` AS `Overall_Rating`,`t1`.`Order_ID` AS `Order_id`,`t1`.`Restaurant_rating` AS `Restaurant_rating`,`t1`.`Driver_rating` AS `Driver_rating` from (`rating` `t1` join `restaurant_rating` `t2` on((`t1`.`Restaurant_rating` = `t2`.`Rating_ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_driver_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_driver_rating` AS select `t1`.`Overall_Rating` AS `Overall_Rating`,`t1`.`Order_ID` AS `Order_id`,`t1`.`Driver_rating` AS `Driver_rating` from (`rating` `t1` join `driver_rating` `t2` on((`t1`.`Restaurant_rating` = `t2`.`Rating_ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_order_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_order_rating` AS select `t1`.`Order_ID` AS `order_id`,`t2`.`total_price` AS `total_price`,`t2`.`delivery_charge` AS `delivery_charge` from (`rating` `t1` join `orders` `t2` on((`t1`.`Order_ID` = `t2`.`order_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vw_restaurant_rating`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_restaurant_rating` AS select `t1`.`Overall_Rating` AS `Overall_Rating`,`t1`.`Order_ID` AS `Order_id`,`t1`.`Restaurant_rating` AS `Restaurant_rating`,`t1`.`Driver_rating` AS `Driver_rating` from (`rating` `t1` join `restaurant_rating` `t2` on((`t1`.`Restaurant_rating` = `t2`.`Rating_ID`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-03-25 16:44:38
